# S2-033: Extract vision/slide description — Деталі для виконавця
...
**Попередня задача:** [S2-032: Extract whisper transcription](../S2-032/README.md)

**Наступна задача:** [S2-034: Extract web scraping](../S2-034/README.md)
...
Unit test з mock vision API

### Ручний контроль (Human testing)

Ingestion презентації → результат ідентичний
