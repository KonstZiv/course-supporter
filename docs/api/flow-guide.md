...
### Крок 5: Визначити необхідність співставлення слайдів з відео

Після завершення ingestion вирішіть, чи потрібно створювати прив'язку слайдів презентації до таймкодів відео. Це опціональний крок, але він може покращити якість генерації структури, надаючи LLM точніший контекст. Якщо співставлення не потрібне — переходьте одразу до кроку 7.

### Крок 6: (Опціонально) Створити Slide-Video Mappings

Якщо у вашому курсі є і презентації, і відео — прив'яжіть конкретні слайди до таймкодів відео.
...
### Крок 8: Отримати згенеровану структуру
